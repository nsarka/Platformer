...
void TextureManager::DrawTexture(std::string id, int destX, int destY, int width, int height, int srcX, int srcY, float angle, SDL_Renderer* pRenderer, SDL_RendererFlip flip)
{
	srcRect.x = srcX;
	srcRect.y = srcY;
